...
import static im.wise.wiseim.authenticator.BootstrapAuthenticatorActivity.PARAM_AUTHTOKEN_TYPE;
...
class BootstrapAccountAuthenticator extends AbstractAccountAuthenticator {
     ...
     * {@link im.wise.wiseim.authenticator.ApiKeyProvider#getAuthKey()}
